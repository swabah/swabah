		...
		>
			...
			>
				...
				>
					...
					<div
						className="absolute inset-0 flex items-center justify-center z-20 pointer-events-none p-4"
					...
					{p.featured && (
						<span
							className="absolute top-4 left-4 sm:top-6 sm:left-6 text-[8px] sm:text-[10px] font-mono uppercase tracking-widest px-2 py-1 rounded-md bg-background/80 backdrop-blur-md border border-primary/50 text-primary shadow-xl"
					...
					{p.caseStudy && (
						<span
							className="absolute top-4 right-4 sm:top-6 sm:right-6 text-[8px] sm:text-[10px] font-mono uppercase tracking-widest px-2 py-1 rounded-md bg-background/80 backdrop-blur-md border border-border text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity"
							style={{ transform: "translateZ(30px)" }}
						>
							Case Study
						</span>
			...
			<div className="flex flex-col flex-1 p-4 sm:p-6">
				...
				<p className="text-[11px] sm:text-sm text-muted-foreground leading-relaxed mb-4 flex-1">
					{p.description}
				</p>
				<div className="flex flex-wrap gap-1 sm:gap-1.5 mb-4 sm:mb-5">
					{p.tech.map((t) => (
						<span
							key={t}
							className="text-[9px] sm:text-[10px] font-mono px-2 py-0.5 sm:py-1 rounded bg-secondary border border-border text-muted-foreground"
						>
							{t}
						</span>
					))}
